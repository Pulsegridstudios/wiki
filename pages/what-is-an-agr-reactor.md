...
- **Advanced** — improved over earlier gas-cooled designs
- **Gas-cooled** — uses gas instead of water as the primary coolant
- **Reactor** — a system that controls nuclear fission to produce heat
...
- **thermal output** — total heat produced by the reactor
- **electrical output** — usable electricity exported by the generator systems
